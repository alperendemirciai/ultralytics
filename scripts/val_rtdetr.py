"""Validate a trained RT-DETR model.
...
Usage:
    python scripts/val_rtdetr.py \
        ...
        --save-dir runs/my_rtdetr_experiment/val
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Validate an RT-DETR model (Ultralytics wrapper)")
